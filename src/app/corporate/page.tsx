  ...
  return (
    <div className="font-pretendard font-light min-h-screen bg-white">
            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:block">
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                  ...
                  <Link href="/corporate" className="text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-200">법인회생</Link>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        <div className="mb-6">
          <h2 className="text-2xl font-normal text-black mb-2">법인회생</h2>
          <p className="text-sm text-gray-600">법인회생 절차와 기업 재구조화 경험을 공유하세요</p>
        </div>

        <div className="mb-6 flex justify-center">
          <div className="w-[728px] h-[90px] bg-green-50 border border-green-200 flex items-center justify-center text-sm text-green-600 rounded-lg">
            <div className="text-center">
              <div className="text-lg mb-1">법인회생 전문 프리미엄 광고</div>
              <div className="text-xs text-green-400">728 × 90 (리더보드)</div>
            </div>
          </div>
        </div>
        ...
        {!loading && posts.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">아직 법인회생 게시글이 없습니다</h3>
            <p className="text-sm text-gray-500 text-center mb-6">
              첫 번째 법인회생 경험담을 작성해보세요!<br />
            ...
            <div className="flex items-center space-x-3">
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">
                  법인회생 전문 컨설팅 - 기업 구조조정 전문
                </p>
                <p className="text-xs text-blue-100 truncate">
                  무료 상담 | 맞춤 전략 | 성공 사례 다수
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
