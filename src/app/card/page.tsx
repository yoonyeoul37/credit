    ...
    <div className="font-pretendard font-light min-h-screen bg-white">
            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:block">
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                  ...
                  <a href="/card" className="text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-200">신용카드</a>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mb-6 flex justify-center">
          <div className="w-[728px] h-[90px] bg-orange-50 border border-orange-200 flex items-center justify-center text-sm text-orange-600 rounded-lg">
            <div className="text-center">
              <div className="text-lg mb-1">신용카드 맞춤 프리미엄 광고</div>
              <div className="text-xs text-orange-400">728 × 90 (리더보드)</div>
            </div>
          </div>
        </div>
