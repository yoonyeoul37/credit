  ...
  return (
    <div className="font-pretendard font-light min-h-screen bg-white">
            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:block">
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                  ...
                  <Link href="/workout" className="text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-200">워크아웃</Link>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        <div className="mb-6">
          <h2 className="text-2xl font-normal text-black mb-2">워크아웃</h2>
          <p className="text-sm text-gray-600">워크아웃 절차와 금융 재구조화 경험을 공유하세요</p>
        </div>

        <div className="mb-6 flex justify-center">
          <div className="w-[728px] h-[90px] bg-purple-50 border border-purple-200 flex items-center justify-center text-sm text-purple-600 rounded-lg">
            <div className="text-center">
              <div className="text-lg mb-1">워크아웃 전문 프리미엄 광고</div>
              <div className="text-xs text-purple-400">728 × 90 (리더보드)</div>
            </div>
          </div>
        </div>
        ...
        {!loading && posts.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">아직 워크아웃 게시글이 없습니다</h3>
            <p className="text-sm text-gray-500 text-center mb-6">
              첫 번째 워크아웃 경험담을 작성해보세요!<br />
