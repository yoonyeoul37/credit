...
export default function NewsPage() {
  ...
  // 페이징 계산
  const totalPages = Math.ceil(allNewsItems.length / postsPerPage);
            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:block">
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                  ...
                  <a href="/news" className="text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-200">뉴스정보</a>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-500">
            전체 {allNewsItems.length}개 뉴스 | {currentPage} / {totalPages} 페이지
          </p>
        </div>
      </main>
